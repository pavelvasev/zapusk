...
Параметры:
* **dir** - каталог хранения файлов флагов, для отслеживания состояния.
* **key** - имя флага.
...
* При прохождении любой команды, будет сохранен флаг (dir,key,global_name). Так как global_name будет разных в разных 
контекстах использования, то для каждого "использования" сохранится отдельный флаг.
* При прохождении команды **destroy**, данный флаг будет снят. Если других флагов (dir,key,global_name) нет,
