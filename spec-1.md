...
## Пространтсва имен экземпляров компонент
...
* `some command` - подстановка stdout выполнения shell-команды.

* {{name}} - подстановка значений других параметров.
...
Результат: будет напечатан текст Hello! если сейчас понедельник, суббота или воскресение.Программные коды
================
